    						...
    						<div class="table-row">
    							<div class="table-cell">
    								<div class="text">
    									...
    									<?php 
                                            echo wpautop( wp_kses_post( wp_trim_words( strip_shortcodes( get_the_content() ), 10, '...' ) ) );
                                            if( $service_read_more ){ ?>
                                                <div class="btn-holder">
                                                    <a href="<?php the_permalink(); ?>" class="btn-learnmore">
                                                        <?php echo esc_html( $service_read_more ); ?><span class="icon"></span>
                                                    </a>
                                                </div>
                                                <?php 
                                            }
