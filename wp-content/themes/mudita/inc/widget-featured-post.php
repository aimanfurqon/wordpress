...
class Mudita_Featured_Post extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        $read_more      = ! empty( $instance['readmore'] ) ? $instance['readmore'] : __( 'Read More', 'mudita' );
        ...
        if( $qry->have_posts() ){
            ...
            ?>
                ...
                <?php echo wpautop( wp_kses_post( wp_trim_words( strip_shortcodes( get_the_content() ), $excerpt_char, '...' ) ) ); ?>
	...
	public function form( $instance ) {
        ...
        ?>
		<p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'post_list' ) ); ?>"><?php esc_html_e( 'Posts', 'mudita' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'readmore' ) ); ?>"><?php esc_html_e( 'Read More Text', 'mudita' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'excerpt_char' ) ); ?>"><?php esc_html_e( 'Excerpt Word Count', 'mudita' ); ?></label> 
