...
// register Mudita_Recent_Post widget
function mudita_register_recent_post_widget() {
    register_widget( 'Mudita_Recent_Post' );
}
add_action( 'widgets_init', 'mudita_register_recent_post_widget' );

if( ! class_exists( 'Mudita_Recent_Post' ) ) : 
 /**
 * Adds Mudita_Recent_Post widget.
 */
class Mudita_Recent_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'mudita_recent_post', // Base ID
			__( 'RARA: Recent Post', 'mudita' ), // Name
			array( 'description' => __( 'A Recent Post Widget', 'mudita' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Recent Posts', 'mudita' );
                ...
                ?>
                    <li>
                        ...
                        <?php }elseif( ! has_post_thumbnail() && $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php mudita_get_fallback_svg( 'mudita-recent-post' ); ?>
                            </a>
                        <?php } ?>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'mudita' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
        
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'num_post' ) ); ?>"><?php esc_html_e( 'Number of Posts', 'mudita' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_thumbnail' ) ); ?>"><?php esc_html_e( 'Show Post Thumbnail', 'mudita' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_postdate' ) ); ?>"><?php esc_html_e( 'Show Post Date', 'mudita' ); ?></label>
		</p>
		<?php 
	}
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? strip_tags( $new_instance['title'] ) : __( 'Recent Posts', 'mudita' );
