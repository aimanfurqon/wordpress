...
function mudita_posted_on() {
	...
	$byline = '<span class="author vcard"><span class="fa fa-user"></span><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>';
